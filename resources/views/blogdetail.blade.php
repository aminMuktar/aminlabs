...
@vite(['resources/css/app.css'])
  ...
  <div class="flex p-5 bg-custom-100 w-full place-content-center">
    <div class="rounded-lg place-content-center shadow-2xl">
      <div class="px-6 py-4 ">
        ...
        <p class="text-gray-700 text-xs lg:text-base p-10 place-content-start text-white">
          {{ $post->description }}
        </p>
      </div>
      <div class="px-6 pt-4 pb-2">
